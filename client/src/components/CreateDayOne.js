...
class CreateDayOne extends Component {
  ...
  render() {
        ...
        // return <option className="" key={index} ref={inclinePushName.exercise} value={inclinePushName.exercise} data-user_id={inclinePushName.user_id} data-exercise_id={inclinePushName.exercise_id} data-category_id={inclinePushName.category_id}>{inclinePushName.exercise}</option>
