                ...
                <ul className="navbar-nav bg-gradient-dark sidebar sidebar-dark accordion" id="accordionSidebar">
                    ...
                    <a className="sidebar-brand d-flex align-items-center justify-content-center" href="/">
                        <div className="sidebar-brand-icon rotate-n-15">
                            ...
                            {/* <img className="" src="../images/MESOCYCLE LOGO_black_bcg.png"/> */}
                        </div>
                        <div className="sidebar-brand-text mx-3"><img className="headerImage" src="../images/MESOCYCLE LOGO_black_bcg.png" alt=""/> Mesocycle </div>
                    </a>
                ...
                <div id="content-wrapper" className="d-flex flex-column">
                    ...
                    <div id="content">
                        ...
                        {/* <nav className="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow"> */}
                            ...
                            {/* <img className="rounded-circle" src="../images/MESOCYCLE LOGO_white_bcg.png" alt=""/> */}
                        ...
                        <footer className="sticky-footer "> 
                            <div className="navbar navBG">
                                <div className="d-flex w-100 h-50">
                                    <img className="headerImage mx-auto" src="" alt=""></img>
                                </div>
                            </div>                             
                        </footer>
                    {/* </footer> */}
